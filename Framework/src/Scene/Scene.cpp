...
{
	Framework::Shader baseVertex = Framework::Shader("res/shaders/base/vertex.vert", GL_VERTEX_SHADER);
	Framework::Shader baseFrag = Framework::Shader("res/shaders/base/fragment.frag", GL_FRAGMENT_SHADER);
